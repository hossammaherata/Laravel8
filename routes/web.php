...
Route::prefix('cms/')->middleware('auth:admin')->group(function () {
    ...
    Route::post('/Admin/generalsearch', [SearchController::class, 'generalsearch'])->name('admin.generalsearch');
...
Route::prefix('cms/')->namespace('Auth')->group(function () {
    ...
    Route::get('password', [AdminAuthController::class, 'showForgetPassword'])->name('admin.forgot_password_view');
    Route::post('forgot-password', [AdminAuthController::class, 'requestNewPassword'])->name('admin.forgot_password');
...
Route::prefix('auth/')->middleware('auth:user')->group(function () {
    ...
    Route::get('/user/message/show/{id}', [AllNotController::class, 'showuser'])->name('show.usermessage');
        Route::get('/user/events/show/{id}', [UserEventController::class, 'showdetails'])->name('show.details');
...
Route::prefix('auth/user')->namespace('Auth')->group(function () {
 ...
 Route::get('password', [UserAuthController::class, 'showForgetPassword'])->name('user.forgot');
    Route::post('forgot-password', [UserAuthController::class, 'requestNewPassword'])->name('user.forgot_password');
