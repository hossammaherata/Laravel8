        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1 style="font-size: 20px">تعديل كاتب</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('author.create') }}" style="font-size: 20px">كاتب جديد</a></li>
                                                    <li class="breadcrumb-item"><a href="{{ route('author.index') }}" style="font-size: 20px">الكُتاب </a></li>
                                <li class="breadcrumb-item"><a href="{{ route('admin.index') }}"
                                        style="font-size: 20px">المسؤولين</a></li>
                                <li class="breadcrumb-item active" aria-current="page" style="font-size: 20px"> تعديل كاتب
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="row clearfix">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="body">
                            <form method="POST" action="{{ route('author.update',[$author->token]) }}" enctype="multipart/form-data">
                                @method('PUT')
                                    ...
                                    <div class="col-md-10 col-sm-10">
                                        ...
                                        <div class="form-group" id="dd">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $author->name }}" style="font-size: 20px" name="name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email"
                                                ...
                                                value="{{ $author->email }}" style="font-size: 20px" name="email"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel"
                                                ...
                                                value="{{$author->mobile}}" style="font-size: 20px" name="mobile"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $author->address }}" style="font-size: 20px" name="address"
                                         ...
                                         <div class="row clearfix">
                                            ...
                                            <div class="col-lg-12">
                                                <label style="font-size: 20px"> الصورة العامة للكاتب </label>

                                                <input type="file" width="590px" height="390px" class="dropify"
                                                    data-default-file="{{ url('images/authors/' . $author->image) }}"
                                            name="image">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="status"
                                                    id="status" @if ($author->status=='Active')
                                                checked @endif>
                      ...
                      <form role="form" id="reset_password_form" method="post">
                                ...
                                <div class="card-footer">
                                    <button type="button" onclick="resetPassword('{{$author->token}}')" class="btn btn-primary">Reset
                                        Password
                                    </button>
                                </div>
                            </form>
...
@section('script')
    ...
    <script>
        function resetPassword(token) {
            axios.put('/cms/author/Password/'+token, {
