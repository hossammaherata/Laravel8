        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="body">
                        <form method="POST" action="{{route('twit.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-10 col-sm-10">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label style="font-size: 20px">رابط الفئة </label>
                                            <input onkeydown="error()" type="text"
                                                class="form-control"
                                                value="{{ old('href') }}" style="font-size: 20px" name="href"
