        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1 style="font-size: 20px">تعديل تاجر</h1>
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.dashbord')}}" style="font-size: 20px">الرئيسية</a></li>
                                ...
                                <li class="breadcrumb-item active" aria-current="page" style="font-size: 20px">تعديل تاجر
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="row clearfix">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="body">
                        <form method="POST" action="{{route('deal.update',[$deal->id])}}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-10 col-sm-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input onkeydown="error()" type="text"
                                                class="form-control "
                                                value="{{ $deal->name }}" style="font-size: 20px" name="name"
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input onkeydown="error()" type="text"
                                                class="form-control"
                                                value="{{ $deal->mobile }}" style="font-size: 20px" name="mobile"
